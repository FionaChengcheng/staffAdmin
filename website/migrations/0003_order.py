...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0002_admin_alter_userinfo_create_time_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.admin', verbose_name='管理员')),
            ],
        ),
    ]
